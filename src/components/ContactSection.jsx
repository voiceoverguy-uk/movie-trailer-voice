      ...
      <div className="container">
        <div className="contact-card">
          ...
          <div className="contact-actions">
            <a href="mailto:info@movietrailervoice.com" className="btn btn-primary">
            ...
            <a href="https://www.youtube.com/@VoiceoverGuy" target="_blank" rel="noopener noreferrer" className="btn btn-ghost">
